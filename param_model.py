...
def run_WDIFF_plots(noise = 0):
    ...
    return [resp1,resp2,resp3,nresp1,nresp2,nresp3]

'''

    utils.dump_file("./inference/param_model_stuff.pkl",[resp1,resp2,resp3,nresp1,nresp2,nresp3])
