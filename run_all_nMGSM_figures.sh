...
sbatch generic_run_script.sh "OMP_NUM_THREADS=28 python general_GSM_responses.py model_files/model_file_32/ rot_surround_suppression --npnt=20 --noiseless --contrast_scaling=.75 --aux_angle=0 --aux_scale = .5"
sbatch generic_run_script.sh "OMP_NUM_THREADS=28 python general_GSM_responses.py model_files/model_file_32/ rot_surround_suppression --npnt=20 --snr=1.0 --TA=50 --contrast_scaling=.75 --aux_angle=0 --aux_scale = .5"
sbatch generic_run_script.sh "OMP_NUM_THREADS=28 python general_GSM_responses.py model_files/model_file_32/ rot_surround_suppression --npnt=20 --snr=1.5 --TA=50 --contrast_scaling=.75 --aux_angle=0 --aux_scale = .5"
sbatch generic_run_script.sh "OMP_NUM_THREADS=28 python general_GSM_responses.py model_files/model_file_32/ rot_surround_suppression --npnt=20 --snr=2.0 --TA=50 --contrast_scaling=.75 --aux_angle=0 --aux_scale = .5"
